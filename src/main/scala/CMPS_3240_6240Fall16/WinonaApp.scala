...
import Readers.{BadgeReader, WinonaReader}
import edu.illinois.cs.cogcomp.saul.util.Logging
/*
import edu.illinois.cs.cogcomp.saulexamples.nlp.EmailSpam.SpamClassifiers._
import scala.collection.JavaConversions._
*/
object WinonaApp extends Logging {

  val allNamesTrain= new WinonaReader("../../../../data/Winona/winona_train").cells
  val allNamesTest= new WinonaReader("../../../../data/Winona/winona_test").cells

  object CellPictureType extends Enumeration {
...
/*
  def main(args: Array[String]): Unit = {
    ...
    val testType = CellPictureType.TrainAndTest

    testType match {
      case CellPictureType.TrainAndTest => TrainAndTestSpamClassifier()
      case CellPictureType.CacheGraph => SpamClassifierWithGraphCache()
      case CellPictureType.TestUsingGraphCache => SpamClassifierFromCache()
      case CellPictureType.TestSerialization => SpamClassifierWithSerialization()
    }
  }
*/
