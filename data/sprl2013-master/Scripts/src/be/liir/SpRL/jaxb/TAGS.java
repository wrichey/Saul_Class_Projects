 ...
 *         &lt;element ref="{}MOTION_INDICATOR" maxOccurs="unbounded"/>
 *         &lt;element ref="{}PATH" maxOccurs="unbounded"/>
 *         &lt;element ref="{}DIRECTION" maxOccurs="unbounded"/>
 *         &lt;element ref="{}DISTANCE" maxOccurs="unbounded"/>
...
public class TAGS {
    ...
    @XmlElement(name = "SPEX", required = false)
    protected List<SPEX> spex;
    ...
    public List<SPEX> getSPEX() {
        if (spex == null) {
            spex = new ArrayList<SPEX>();
        }
        return this.spex;
    }
